...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View'), array('action' => 'view', $paypalItem['PaypalItem']['id'])); ?>
			<?php echo $html->link(__('Edit'), array('action' => 'edit', $paypalItem['PaypalItem']['id'])); ?>
			<?php echo $html->link(__('Delete'), array('action' => 'delete', $paypalItem['PaypalItem']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $paypalItem['PaypalItem']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
